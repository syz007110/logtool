export const mobileRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'surgeries/:deviceId', name: 'MDeviceSurgeries', component: () => import('../../mobile/views/DeviceDetailTabs.vue'), meta: { hideTabbar: true, isMobile: true } },
      { path: 'motions/:deviceId', name: 'MDeviceMotions', component: () => import('../../mobile/views/DeviceDetailTabs.vue'), meta: { hideTabbar: true, isMobile: true } },
