  ...
  hasPermission: (state) => (permission) => {
    try {
      ...
      const rolePermissions = {
        ...
        expert: ['error_code:create', 'error_code:read', 'error_code:update', 'error_code:delete', 'error_code:export', 'log:upload', 'log:read_all', 'log:read_own', 'log:parse', 'log:download', 'log:delete_own', 'i18n:create', 'i18n:read', 'i18n:update', 'i18n:delete', 'history:read_own', 'surgery:analyze', 'surgery:read', 'surgery:export', 'data_replay:upload', 'data_replay:read', 'data_replay:download'],
