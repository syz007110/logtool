...
- 支持上传日志文件，日志文件最多一次可以上传 1000 个；
- 上传并解密的日志存储在服务器指定的路径中；
- 支持日志的解密功能，具体的解密算法预留接口；
- 日志解密后的内容为：
  时间戳、故障码、参数 1、参数 2、参数 3、参数 4、日志解释
- 支持日志的分析功能，针对日志解密后内容支持高级搜索；
- 后续可以添加一些日志具体分析的功能，预留接口；
- 支持解密后的日志下载功能；
- 支持查看日志解密的历史记录，
  普通用户可以查看自己上传的历史日志；
  专家用户和管理员用户可以查看所有人上传的历史日志
